...
const Icon = ({styles, name, imgUrl, isActive, disabled, handleClick }) => (
    ...
    flex justify-center items-center ${!disabled && 'cursor-pointer'} ${styles}`} onClick={handleClick}>
        {!isActive ? ( <img src={imgUrl} alt="fund-logo" className="w-1/2 h-1/2"/>) : 
...
export default function Sidebar(){
    ...
    return(
        ...
        <div className="flex justify-between items-center flex-col sticky top-5 h-[93vh]">
            ...
            <div className="flex-1 flex flex-col justify-between iteams-center bg-[#1c1c24] rounded-[20px] w-[76px] py-4 mt-12">
                ...
                <Icon styles="bg-[#1c1c24] shadow-secondary self-center" imgUrl={sun}/> 
            </div>
        </div>
    )
}